  ...
  (
    ...
    return (
      <div>
        ...
        <label
          className={clsx(
            'border-gray-150 flex cursor-pointer items-center gap-3 rounded-lg border-2 py-3 px-4',
            selected
              ? 'bg-white text-black sm:bg-white sm:text-black'
              : 'bg-transparent text-white sm:text-white',
          )}
          htmlFor={`${name}.${id}`}
        ...
        >
          <Icon
            ...
            className={clsx(
              'h-6 w-6 shrink-0',
              selected && 'text-[rgba(115,142,27,255)]',
            )}
          />
          <span>{label}</span>
        </label>
