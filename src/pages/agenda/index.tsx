...
import { AgendaHeaderWordmark } from '~/components/Icons'
    ...
    <Wrapper className="px-5 pt-10 pb-14">
      ...
      <div className="mx-auto max-w-screen-sm space-y-5">
        {AGENDA[selectedDate].map((agenda, i) => (
          <div
            key={`${selectedDate}-${i}`}
            className={clsx('rounded-xl p-5', i % 2 === 0 ? 'bg-[#4B9D4D]/60 backdrop-blur-lg' : 'bg-[#AB804D]/60 backdrop-blur-lg')}
          >
