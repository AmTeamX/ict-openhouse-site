          ...
          <ol className="list-inside list-disc">
            <li>
              ...
              <span className="font-bold text-dst-prussian-blue">
                ชื่อ นามสกุล อีเมล หมายเลขโทรศัพท์ จังหวัดที่อยู่อาศัย ชื่อสถานศึกษาและระดับการศึกษา รูปโปรไฟล์จากแอพพลิเคชันไลน์ เป็นต้น
              </span>{' '}
        ...
        <div>
          <ol className="list-inside list-disc">
            <li>
              ...
              <span className="font-bold text-dst-prussian-blue">
                name, last name, email, telephone number, residential province, name of school, education level, and line profile
                etc.,
              </span>{' '}
