  ...
  return (
    <Wrapper className="px-5 py-10">
      <div className="mx-auto max-w-screen-md pt-20">
        ...
        <img src="/static/images/nstar/nstar_correct.svg" className="mx-auto pl-10 h-40 max-w-sm drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]" alt="Correct Answer" />

        <div className="mt-10 w-full space-y-5 text-center">
          <div className="font-heading text-3xl font-bold text-ict-turquoise drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
            {t('QUEST_RESULT.CORRECT_TITLE', { ns: 'activity' })}
          </div>
          <div className="font-heading text-2xl drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">{t('QUEST_RESULT.CORRECT_SUBTITLE', { ns: 'activity' })}</div>
        </div>
