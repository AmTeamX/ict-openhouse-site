  ...
  return (
    <Wrapper className="px-5 py-10">
      <div className="mx-auto max-w-screen-md mt-10">
        <Header />
        <div className="my-8 pt-10 text-center font-heading drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
          <h1 className="mb-2 text-3xl font-bold">{t('ACTIVITY_SUMMARY.TITLE', { ns: 'activity' })}</h1>
