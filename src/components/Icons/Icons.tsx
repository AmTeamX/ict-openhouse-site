...
export const IctMahidolOpenHouseWordmark: IconType = (props) => {
  return (
    <Image width='400' height='400' alt='ICT Mahidol Open House 2023' src='/static/images/Logo.png'></Image>
  )
}
...
export const AgendaHeaderWordmark: IconType = (props) => {
  return (
    <Image width='500' height='500' alt='ICT Mahidol Open House 2023' src='/static/images/Logo.png'></Image>
  )
}
